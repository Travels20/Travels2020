    ...
    <div class="container">
        <div class="row section">
            <div class="col-md-12 col-lg-5">
				...
				<h1> {{ __('Group Tour or Custom Tour') }} </h1>
				...
				<div class="form-group mb-3"><label for="adults">No. of Passengers</label>
				<input type="number" id="adults" name="adults" class="form-control mb-2" placeholder="{{ __('Adults') }}" min="0" inputmode="numeric">
				<input type="number" id="children" name="children" class="form-control" placeholder="{{ __('Children') }}" min="0" inputmode="numeric">
				</div>

                                <div class="form-group">
                                    <textarea name="message" cols="40" rows="10" class="form-control textarea" placeholder="{{ __('Message: Describe about your tour') }}"></textarea>
                                </div>
                                <div class="form-group">
