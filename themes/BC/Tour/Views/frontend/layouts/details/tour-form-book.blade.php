            ...
            <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                <div class="form-content">
                    <div class="form-group form-date-field form-date-search clearfix " data-format="{{get_moment_date_format()}}">
                        ...
                        {{--<div class="d-flex p-2  flex-wrap clearfix text-center" v-else-if="date_select_type == 'dropdown'">
                        ...
                        <div class="date-wrapper clearfix" @click="openStartDate" v-else>
                            <div class="check-in-wrapper">
                                ...
                                <div class="render check-in-render">@{{start_date_html}}</div>
                                 <!-- <div class="render check-out-render">@{{ end_date_html }}</div> -->
                            </div> 
                            <i class="fa fa-angle-down arrow"></i>
                        </div>
                        <input type="text" class="start_date" ref="start_date" style="height: 1px; visibility: hidden">
                        <!-- <input type="text" class="end_date" ref="end_date" style="height: 1px; visibility: hidden"> -->
                    </div>
