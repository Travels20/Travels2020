...
jQuery(function ($) {
    ...
    $('.bravo-form-login [type=submit]').click(function (e) {
        ...
        console.log(bookingCore.url, "what i thiss");
        $.ajax({
    ...
    //     document.getElementById('otp-login-form').classList.add('d-none');
    // });

    // document.getElementById('otp-login-btn').addEventListener('click', function () {
    //     document.getElementById('otp-login-form').classList.remove('d-none');
    ...
    //             .then((response) => {
    //                 if (!response.ok) {
    //                     document.getElementById('error-mobile').innerText = 'Unable to send OTP to this number!';
    //                     throw new Error(`HTTP error! Status: ${response.status}`);
    //                 } else {
    //                     document.getElementById('otp-success-mobile').innerText = 'OTP sent successfully!';
    //                     document.getElementById('otp-section').classList.remove('d-none');
    //                 }
    ...
    //                 document.getElementById('error-mobile').innerText = 'An error occurred while sending the OTP.';
    //             });
    ...
    $('.bravo-form-otplogin [type=submit]').click(function (e) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                $('#otp-error').text(''); // Clear error before sending request
                $('.icon-loading').css("display", 'inline-block'); // Show loading icon
            },
            dataType: 'json',
            success: function (data) {
