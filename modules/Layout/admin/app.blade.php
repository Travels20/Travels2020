...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Travels2020'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right">
                        {{date('Y')}} &copy; {{__('Travels2020 by')}} <a
                            href="{{__('https://www.travels2020.com')}}" target="_blank"
                        >{{__('Travels2020 Team')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://www.travels2020.com')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://m.me/travels2020')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
