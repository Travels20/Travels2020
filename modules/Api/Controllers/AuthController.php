...
class AuthController extends Controller
{
    ...
    {
        $this->middleware('auth:sanctum', ['except' => ['login','otplogin','verifyOtp','register','forgotPassword','resetPassword']]);
    }
    ...
    //     if (!$storedOtp || !$storedPhone || $storedPhone !== $request->phone || $storedOtp != $request->otp) {
    //         return response()->json([
    //             'success' => false,
