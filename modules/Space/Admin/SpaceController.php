...
class SpaceController extends AdminController
{
    ...
    public function store( Request $request, $id ){
        ...
        if (!isset($translation) || !$translation) {
            $translation = new $this->space_translation(); // Ensure it's an object
        }
        
        if (!is_array($translation->activities) && !empty($translation->activities)) {
            $translation->activities = json_decode($translation->activities, true);
        }
